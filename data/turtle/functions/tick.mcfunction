...
execute at @a[team=green] as @p if score @p shootDelay matches ..0 if score @p fungusUses matches 1.. if predicate turtle:has_gun run summon arrow ~ ~1.5 ~ {Tags:["bullet"],CustomName:'{"text":"Green Paintball","color": "#88ff88"}',Silent:1b}
execute at @a[team=red] as @p if score @p shootDelay matches ..0 if score @p fungusUses matches 1.. if predicate turtle:has_gun run summon arrow ~ ~1.5 ~ {Tags:["bullet"],CustomName:'{"text":"Red Paintball","color": "#ff8888"}',Silent:1b}
